![](https://github.com/SenshiSentou/sd-webui-tinycards/blob/mastercard-beta/toma-chan.png)
...
![](https://github.com/SenshiSentou/sd-webui-tinycards/blob/mastercard-beta/compact-detail-view.png)
...
In addition, Card Master will split the activation text out into separate sections if the first tag is ever repeated. For example, `pokemonlillie, long hair, outfit1, pokemonlillie, ponytail, outfit2` will be split into `pokemonlillie, long hair, outfit1` and `pokemonlillie, ponytail, outfit2`.

## Behaviours to be aware of

There are a couple things Card Master is opinionated about, and deviates from the default A1111 behaviour.
